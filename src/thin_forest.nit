...
class Case
    ...
    fun draw( display : SDLDisplay, imgs : HashMap[String,Image], 
              x, y : Int )
    do
        if tree != null
        then
...
special Game
    ...
    do
        if e isa ThinTreeEvent
        then
            var p = e.pos
            
            if in_sight( p )
            then                        
                if e isa ThinTreeFallEvent
                then
                ...
                else if e isa ThinTreeBirthEvent
                then
                    ...
                    trees.add( t )
                else if e isa ThinTreeGrowthStopEvent
                then
                    var t = local_case_for( p ).tree
                ...
                else if e isa ThinTreeDeathEvent
                then
                    var t = local_case_for( p ).tree
