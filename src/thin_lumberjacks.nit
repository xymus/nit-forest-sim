...
redef class ThinForest
    ...
    do
        if e isa ThinLumberjackEvent
        then
            if e isa ThinLumberjackBirthEvent
            then
                var p = e.pos
                if in_sight( p )
                then
            ...
            else if e isa ThinLumberjackWorkEvent
            then
                var p = e.pos
                if in_sight( p )
                then
            ...
            else if e isa ThinLumberjackMoveEvent
            then
                var from = e.from
                var to = e.to
